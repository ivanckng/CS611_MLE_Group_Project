...
def main():
    print('\n\n---starting job ~ Gold table feature store---\n\n')
    ...
    for date_str in dates_str_lst:
        utils.gold.process_gold_featurestore(date_str, silver_transaction_directory, silver_userlog_directory, silver_member_directory, gold_feature_store_directory, spark)


    # end spark session
    spark.stop()
    print('\n\n---Done Build Gold Feature store---\n\n')
